...
#define UART1_RX_PIN    C3        //C3、E1   //openmv
#define UART1_TX_PIN    C4        //C4、E0

#define UART2_RX_PIN    D2        //D2      //不能用 电机冲突
#define UART2_TX_PIN    D3        //D3

#define UART3_RX_PIN    C16       //B10、C16、E5
#define UART3_TX_PIN    C17       //B11、C17、E4

#define UART4_RX_PIN    E25       //C14、E25 //蓝牙
...
//      模块通道        端口      可选范围                建议
#define FTM3_CH0_PIN    D0        //D0 
#define FTM3_CH1_PIN    D1        //D1 
#define FTM3_CH2_PIN    D2        //D2 
